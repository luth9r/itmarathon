...
import { DeleteConfirmationModal } from './shared/components/modal/delete-confirmation-modal/delete-confirmation-modal';
...
export type ModalInputs =
  ...
  | DeleteConfirmationModalInputs;

export type ModalOutputs = Record<string, (...args: unknown[]) => void>;

export interface DeleteConfirmationModalInputs {
